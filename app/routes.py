...
def user(username):
    ...
    if posts.has_next:
        next_url=url_for('user', username=user.nickname, page=posts.next_num)
    else:
        next_url = None
    if posts.has_prev:
        prev_url=url_for('user', username=user.nickname, page=posts.prev_num)
    else:
        prev_url = None
    print(user)
